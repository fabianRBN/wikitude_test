...
public interface ArchitectViewHolderInterface {
    //Reference : Wikitude Android JAVASCRIPT API - Android wikitude-sdk-samples
    /**
    ...
    /**
     * @return Launcher id of your Launcher.xmlml that holds an ARchitect View, e.g. R.Launcher.camview
     */
    ...
    /**
     * @return Launcher-id of architectView, e.g. R.id.architectView
     */
